// This program is about Circular Queue implementation using array
#include<stdio.h>
#include<stdlib.h>
struct Queue
{
    int size;
    int front;  //used for front pointer
    int rear;   //used for rear pointer
...
{
    if ((arr->front == -1 && arr->rear == arr->size-1))
    {
        return 1;
    }
    else
